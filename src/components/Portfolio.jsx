...
const Portfolio = () => {
  return (
    <div name='portfolio' className='p-10 bg-gradient-to-b from-slate-900 to-slate-800 w-full md:h-screen text-white'>
        ...
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
            ...
            <div key={id} className='shadow-md shadow-gray-600 rounded-lg'>
                <img src={src} alt="placeholder" className='rounded-md duration-200 hover:scale-105 w-full '/>
            ...
            <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px0'>
                <div className='shadow-md shadow-gray-600 rounded-lg'>
                    <img src={placeholder} alt="placeholder" className='rounded-md duration-200 hover:scale-110 w-full '/>
                    <div className='flex items-center justify-center'>
