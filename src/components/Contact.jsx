...
const style = {
    ...
    button: `group text-white w-fit px-6 py-3 my-2 mx-auto flex items-center rounded-md bg-gradient-to-br from-cyan-500 to-blue-600 hover:scale-110 duration-300`
    }

const Contact = () => {
  return (
    <div name='contact' className='p-10 w-full h-screen bg-gradient-to-b from-slate-900 to-slate-800 text-white'>
